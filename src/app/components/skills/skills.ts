...
export class Skills {
  ...
  categories: SkillCategory[] = [
    {
      title: 'Frontend',
      icon: this.sanitizer.bypassSecurityTrustHtml(`<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/></svg>`),
      skills: [
